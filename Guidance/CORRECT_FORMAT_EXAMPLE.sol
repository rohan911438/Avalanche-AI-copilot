// Example of a correctly formatted contract for easy compilation in our frontend
// No imports - all dependencies inlined directly

// SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

// Inlined ReentrancyGuard implementation
